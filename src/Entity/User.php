...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    {
        $this->license_plate = new ArrayCollection();
     ...
     */
    public function getLicensePlate(): Collection
    {
    ...
    {
        if (!$this->license_plate->contains($licensePlate)) {
    ...
    {
        if ($this->license_plate->removeElement($licensePlate)) {
